...
class Gold : public Event {
    ...
    public:
        ...
        ** Description: Prints the signifier for the Gold object.
        ** Parameters: None
        ** Pre-Conditions: None
        ** Post-Conditions: The signifier for the Gold object is printed.
        *********************************************************************/
        void print_event();

        /*********************************************************************
        ** Function: print_percept()
        ** Description: Prints the percept for the Gold object.
        ** Parameters: None
        ** Pre-Conditions: None
        ** Post-Conditions: The percept for the Gold object is printed.
        *********************************************************************/
        void print_percept();

        /*********************************************************************
        ** Function: print_encounter()
        ** Description: Prints the encounter message for the Gold object and returns a corresponding value.
        ** Parameters: None
        ** Pre-Conditions: None
        ...
        ** Description: Sets the member variable for the x coordinate of the Gold object.
        ** Parameters:
        ...
        ** Description: Sets the member variable for the y coordinate of the Gold object.
        ** Parameters:
        ...
        ** Description: Returns the member variable for the x coordinate of the Gold object.
        ** Parameters: None
        ** Pre-Conditions: None
        ...
        ** Description: Returns the member variable for the y coordinate of the Gold object.
        ** Parameters: None
        ** Pre-Conditions: None
